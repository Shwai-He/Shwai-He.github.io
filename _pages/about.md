...
<p class="bio-paragraph">
My research investigates the theoretical, algorithmic, and architectural principles governing <strong>efficient foundation models</strong>. In particular, I study how parameters, representational geometry, and computational paths interact inside large models—disentangling true model capacity from structural redundancy. Guided by these insights, I develop principled methods for <strong>conditional and dynamic computation</strong> (e.g., dynamic depth routing and expert load balancing in MoEs), <strong>representation-guided model compression</strong> (e.g., geometric pruning and layer dropping), and <strong>parameter-efficient adaptation</strong>.
</p>

<p class="bio-paragraph">
To ensure these algorithmic advances translate into practical real-world throughput, I design <strong>hardware- and system-aware paradigms</strong> for distributed serving and large-scale deployment. My recent work extends these principles toward <strong>unified multimodal sparsity</strong> and <strong>efficient dense retrieval</strong> across language, vision, and video. Broadly, my goal is to bridge foundational model understanding, algorithm design, and system efficiency, enabling foundation models that are substantially faster, more economical, and universally accessible without compromising capability.
</p>
